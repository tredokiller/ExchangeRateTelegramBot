...
public class Messages
{
    ...
    public const string ParseExceptionMessage = "Не вдалося надати інформацію за цією датою. Архів зберігає повну інформацію за останні 4 роки";
